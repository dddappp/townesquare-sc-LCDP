...
public class UserEventId implements Serializable {
    ...
    public UserEventId(String userWallet, BigInteger version)
    {
        this.userWallet = userWallet;
        this.version = version;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        return true 
            && (userWallet == other.userWallet || (userWallet != null && userWallet.equals(other.userWallet)))
    ...
    public int hashCode()
    {
        ...
        if (this.userWallet != null) {
            hash += 13 * this.userWallet.hashCode();
        }
