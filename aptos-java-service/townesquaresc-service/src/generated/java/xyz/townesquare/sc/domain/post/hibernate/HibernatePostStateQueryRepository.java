...
public class HibernatePostStateQueryRepository implements PostStateQueryRepository {
    ...
    public PostState get(BigInteger id) {
        ...
        PostState state = (PostState)getCurrentSession().get(AbstractPostState.SimplePostState.class, id);
    ...
    public Iterable<PostState> getAll(Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(PostState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<PostState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(PostState.class);
        criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
        HibernateUtils.criteriaAddFilterAndOrdersAndSetFirstResultAndMaxResults(criteria, filter, orders, firstResult, maxResults);
        addNotDeletedRestriction(criteria);
    ...
    @Transactional(readOnly = true)
    public PostState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders) {
        List<PostState> list = (List<PostState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public PostState getFirst(Map.Entry<String, Object> keyValue, List<String> orders) {
